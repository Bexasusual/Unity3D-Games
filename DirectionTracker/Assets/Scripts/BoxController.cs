...
public class BoxController : MonoBehaviour
{
    ...
    private void CheckLevel()
    {
        ...
        if (level >= 1 && level <= 3)
        {
            ...
            for (int i = 0; i < 2; i++) { ValueArray[i] = Random.Range(3, 13); }
        ...
        else if (level >= 4 && level <= 8)
        {
            ...
            for (int i = 0; i < 4; i++) { ValueArray[i] = Random.Range(3, 13); }
        ...
        else if(level >= 9 && level <= 15)
        {
            ...
            for (int i = 0; i < 6; i++) { ValueArray[i] = Random.Range(3, 13); }
        ...
        else
        {
            ...
            for (int i = 0; i < 8; i++) { ValueArray[i] = Random.Range(3, 13); }
